        ...
        <div className="space-y-4 pt-2">
          ...
          {photoPreview ? (
            <div className="relative rounded-lg overflow-hidden border border-border bg-muted">
              <img src={photoPreview} alt="Your watch" className="w-full h-48 object-contain bg-black/5" />
              <Button
                variant="ghost"
                size="icon"
          ...
          <p className="text-xs text-muted-foreground text-center">
            Photo-based generation works best for microbrands and niche watches where AI lacks training data.
          </p>
        </div>
      </DialogContent>
    </Dialog>
